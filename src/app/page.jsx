...
import { information, socialLinks } from "./data/config";
import { Divider } from "@nextui-org/divider";
import CVDownloader from "./components/items/CVDownloader";
    ...
    <>
      <div className="flex flex-col md:flex-row items-start justify-between gap-12 mt-12 mb-20">
        ...
        <div className="flex-1 space-y-6">
          <h1 className="m-5 mb-8 x font-extrabold text-gray-900 sm:text-5xl tracking-tight">
            <span className="font-extrabold text-indigo-700">[</span> Rémy !
      ...
      <div>
        <br />
        <h2 className="m-5 font-bold text-grey-900 sm:text-3xl text-center tracking-wider space-x-4">
          Mes projets
        </h2>
        <ProjectSlider projects={projects} />
        <div className="flex justify-center mt-8">
          <Link className="text-indigo-700 hover:underline" href="/projects">
            Voir plus
          </Link>
        </div>
      </div>
