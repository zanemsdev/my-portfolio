...
function SocialLink({ href, icon: Icon }) {
  return (
    <a href={href} target="_blank" rel="noopener noreferrer" className="text-gray-700 transition hover:opacity-75 hover:text-indigo-700">
      <Icon />
    </a>
  );
}
  ...
  <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-10 sm:px-6 lg:px-8 lg:pt-10">
    ...
    <div className="mt-8 border-t border-gray-100 pt-8 sm:flex sm:items-center sm:justify-between lg:mt-24">
      <ul className="flex flex-wrap justify-center gap-4 text-xs lg:justify-end">
        <li>
          <a href="https://www.remy-chevalier.fr" className="text-gray-500 transition hover:opacity-75 hover:text-indigo-700">&copy; {YEAR}. Rémy CHEVALIER. All rights reserved. </a>
        </li>
      </ul>
