export default function Home() {
    return (
        <div className="bg-gray-100 p-8 rounded-lg shadow-md">
            <h1 className="text-3xl font-bold mb-4">SterNdev</h1>
            <p className="text-lg mb-4">
            Bienvenue sur SterNdev, une plateforme dédiée au domaine de l'informatique et du développement. Visitez notre site  <a href="https://sterndev.fr" className="text-indigo-700 underline">sterndev.fr</a> pour plus d'informations.
            </p>
            <p className="text-lg">
